  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterReactApp.jobHistory.delete.question">
          <Translate contentKey="jhipsterReactApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
