    ...
    return (
      <div>
        <h2 id="region-heading">
          <Translate contentKey="jhipsterReactApp.region.home.title">Regions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterReactApp.region.home.createLabel">Create a new Region</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {regionList && regionList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jhipsterReactApp.region.regionName">Region Name</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterReactApp.region.home.notFound">No Regions found</Translate>
            </div>
          )}
        </div>
      </div>
