  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterReactApp.department.delete.question">
          <Translate contentKey="jhipsterReactApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
