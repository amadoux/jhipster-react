    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterReactApp.job.home.createOrEditLabel">
              <Translate contentKey="jhipsterReactApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : jobEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="job-task">
                    <Translate contentKey="jhipsterReactApp.job.task">Task</Translate>
                  </Label>
                  <AvInput
                    id="job-task"
                    type="select"
